...
namespace AcademyOps.Tests.Integration;
...
public sealed class EmailOutboxTests
{
    ...
    {
        var options = new DbContextOptionsBuilder<AcademyOpsDbContext>()
            .UseSqlServer(
                "Server=localhost;Database=AcademyOpsDb;" +
                "Trusted_Connection=True;TrustServerCertificate=True")
            .Options;
        using var dbContext = new AcademyOpsDbContext(options);
    ...
    private sealed class OutboxFixture : IAsyncDisposable
    {
        ...
        public AcademyOpsDbContext DbContext { get; }
            ...
            Exception? sendException = null)
        {
            ...
            var options = new DbContextOptionsBuilder<AcademyOpsDbContext>()
                ...
                .Options;
            var dbContext = new AcademyOpsDbContext(options);
