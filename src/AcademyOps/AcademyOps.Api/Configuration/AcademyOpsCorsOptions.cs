...
public sealed class AcademyOpsCorsOptions
{
...
internal sealed class AcademyOpsCorsOptionsValidator
    : IValidateOptions<AcademyOpsCorsOptions>
{
    private readonly IHostEnvironment _environment;

    public AcademyOpsCorsOptionsValidator(IHostEnvironment environment)
    {
