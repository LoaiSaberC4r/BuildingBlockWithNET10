...
public sealed class AcademyOpsDbContext(DbContextOptions<AcademyOpsDbContext> options)
    : DbContext(options)
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.ApplyWriteConfigurations(typeof(AcademyOpsDbContext).Assembly);
